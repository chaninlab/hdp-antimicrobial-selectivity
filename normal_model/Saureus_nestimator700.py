...
scores.to_csv("./Saureus_evaluation_metrics_nestimator700.csv")                                  # Saving the DataFrame into csv.
...
gini_importance.to_csv("./Saureus_gini_importance_nestimator700.csv")                                    # Saving the DataFrame.
...
permutation_importance_df.to_csv("./Saureus_permutation_importance_nestimator700.csv")                             # Saving the DataFrame.
