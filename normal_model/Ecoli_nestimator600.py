...
scores.to_csv("./Ecoli_evaluation_metrics_nestimator600.csv")                                  # Saving the DataFrame into csv.
...
gini_importance.to_csv("./Ecoli_gini_importance_nestimator600.csv")                                    # Saving the DataFrame.
...
permutation_importance_df.to_csv("./Ecoli_permutation_importance_nestimator600.csv")                             # Saving the DataFrame.
