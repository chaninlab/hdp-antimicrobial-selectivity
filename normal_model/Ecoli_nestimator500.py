...
scores.to_csv("./Ecoli_evaluation_metrics_nestimator500.csv")                                  # Saving the DataFrame into csv.
...
gini_importance.to_csv("./Ecoli_gini_importance_nestimator500.csv")                                    # Saving the DataFrame.
...
permutation_importance_df.to_csv("./Ecoli_permutation_importance_nestimator500.csv")                             # Saving the DataFrame.
