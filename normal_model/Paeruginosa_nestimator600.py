...
for seed in range(123, 148):                                              # Iterating the Loop for 25 times.
  model = RandomForestClassifier(n_estimators=600,                        # Instantiating the Classifier.
...
scores.to_csv("./Paeruginosa_evaluation_metrics_nestimator600.csv")                                  # Saving the DataFrame into csv.
...
gini_importance.to_csv("./Paeruginosa_gini_importance_nestimator600.csv")                                    # Saving the DataFrame.
...
permutation_importance_df.to_csv("./Paeruginosa_permutation_importance_nestimator600.csv")                             # Saving the DataFrame.
