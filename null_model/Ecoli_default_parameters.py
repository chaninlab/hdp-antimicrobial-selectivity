...
# Getting the Data:
github_url = "Ecoli_desc_from_1st_run_master.csv"
...
scores.to_csv("./Ecoli_evaluation_metrics_default.csv")                                  # Saving the DataFrame into csv.
...
gini_importance.to_csv("./Ecoli_gini_importance_default.csv")                                    # Saving the DataFrame.
...
permutation_importance_df.to_csv("./Ecoli_permutation_importance_default.csv")                             # Saving the DataFrame.
